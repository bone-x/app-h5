 ...
 * @LastEditTime : 2020-01-16 16:12:17
 * @LastEditors  : 尹伊
 * @Description: 单科详情-面授
 ...
 <template>
  <div class="subject">
    ...
    <div class="sub-bottom">
      <Footer :xiaoNengUrl='infoData.xiaoNengUrl' :hasBoughtGoods='infoData.hasBoughtGoods' :videoType='videoType' :isCollected='infoData.isCollected' :collectionId='infoData.id'></Footer>
    </div>
    <!-- 弹框 -->
    <van-dialog
      v-model="show"
